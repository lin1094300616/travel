...
public class FileUtil {
     ...
     **/
    public static String fileUpload(String type,Integer entityId,MultipartFile multipartFile) {
        //1.判断文件是否存在
        if (multipartFile == null || multipartFile.isEmpty()) {
            return null;
        }

        //2.判断文件是否为jpg、jpeg、png、bmp
        ...
        //3.获得存放路径：主路径+类型+实体ID 如 D:\IDEAWord\Scenery\
        String path = ConstantsEnum.UPLOAD + type + "\\" + entityId + "\\";
